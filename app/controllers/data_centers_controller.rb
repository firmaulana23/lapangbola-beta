class DataCentersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @data_center.save
        format.html { redirect_to @data_center, notice: "Data center was successfully created." }
  ...
  def update
    respond_to do |format|
      if @data_center.update(data_center_params)
        format.html { redirect_to @data_center, notice: "Data center was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to data_centers_path, status: :see_other, notice: "Data center was successfully destroyed." }
  ...
  private
    ...
    def set_data_center
      @data_center = DataCenter.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def data_center_params
      params.fetch(:data_center, {})
    end
end
